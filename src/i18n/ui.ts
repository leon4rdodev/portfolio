...
export const ui = {
  es: {
    ...
    // Hero
    'hero.eyebrow': 'Disponible para trabajos remotos',
    'hero.role': 'Fullstack Developer',
    'hero.tagline': 'Construyo cosas simples y funcionales, y amo lo que hago.',
    'hero.bio': 'Hola, soy Leonardo. Desde que empecé como desarrollador freelance, he trabajado de forma remota con agencias, consultado para startups y colaborado con equipos talentosos para crear productos digitales que la gente realmente usa. Me muevo rápido, escribo código limpio y entrego resultados, no excusas.',
    'hero.cta': 'Hablemos →',
    ...
    'contact.whatsapp.sub': '+1 849 399 7434',
    'contact.email': 'EMAIL',
  ...
  en: {
    ...
    // Hero
    'hero.eyebrow': 'Available for remote work',
    'hero.role': 'Fullstack Software Engineer',
    'hero.tagline': 'I build beautifully simple things, and I love what I do.',
    'hero.bio': "Hi, I'm Leonardo. Since starting my journey as a freelance developer, I've done remote work for agencies, consulted for startups, and collaborated with talented teams to create digital products people actually use. I move fast, write clean code, and deliver results — not excuses.",
    'hero.cta': "Let's talk →",
